$(document).ready(function () {
  $.get(
    ...
    function (data) {
      $("#clima").append(
<<<<<<< HEAD
        "<div class='col-12'><img src='"+'../bakaNeko/resources/bakaNeko2.svg' +"' width='15%'><h1>BakaWeather</h1>El clima donde vive tu waifu (´,,•ω•,,)♡ ahorita es: <br><h1>  " +
=======
        "<div class='col-12'><img src='{% static 'bakaNeko/resources/bakaNeko2.svg' %}' width='15%'><h1>BakaWeather</h1>El clima donde vive tu waifu (´,,•ω•,,)♡ ahorita es: <br><h1>  " +
>>>>>>> main
